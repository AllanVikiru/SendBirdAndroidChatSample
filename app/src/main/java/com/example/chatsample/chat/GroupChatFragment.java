...
import com.example.chatsample.utils.FileUtils;
import com.example.chatsample.utils.MediaPlayerActivity;
import com.example.chatsample.utils.PhotoViewerActivity;
import com.example.chatsample.utils.TextUtils;
import com.example.chatsample.utils.UrlPreviewInfo;
import com.example.chatsample.utils.WebUtils;
...
public class GroupChatFragment  extends Fragment{  private static final String LOG_TAG = GroupChatFragment.class.getSimpleName();
        ...
        public static GroupChatFragment newInstance(@NonNull String channelUrl) {
            ...
            args.putString(AllChatsListFragment.EXTRA_GROUP_CHANNEL_URL, channelUrl);
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            if (savedInstanceState != null) {
                ...
                mChannelUrl = getArguments().getString(AllChatsListFragment.EXTRA_GROUP_CHANNEL_URL);
            }
        ...
        public void onAttach(Context context) {
            ...
            ((AllChatsActivity)context).setOnBackPressedListener(new AllChatsActivity.onBackPressedListener() {
                @Override
        ...
        private void updateActionBarTitle() {
            ...
            if (getActivity() != null) {
                ((AllChatsActivity) getActivity()).setActionBarTitle(title);
            }
        }
