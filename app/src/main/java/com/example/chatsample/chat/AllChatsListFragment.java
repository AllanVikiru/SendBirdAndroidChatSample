...
import com.example.chatsample.main.ConnectionManager;
 ...
 * {@link AllChatsListFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AllChatsListFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AllChatsListFragment extends Fragment {
    ...
    private AllChatsListAdapter mChannelListAdapter;
    private FloatingActionButton mCreateChannelFab;
    private GroupChannelListQuery mChannelListQuery;
    private SwipeRefreshLayout mSwipeRefresh;

    public static AllChatsListFragment newInstance() {
        AllChatsListFragment fragment = new AllChatsListFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.d("LIFECYCLE", "AllChatsListFragment onCreateView()");

        View rootView = inflater.inflate(R.layout.fragment_all_chats_list, container, false);

        setRetainInstance(true);

        // Change action bar title
        ((AllChatsActivity) getActivity()).setActionBarTitle(getResources().getString(R.string.all_group_channels));
        ...
        mChannelListAdapter = new AllChatsListAdapter(getActivity());
    ...
    public void onResume() {
        Log.d("LIFECYCLE", "AllChatsListFragment onResume()");
    ...
    public void onPause() {
        ...
        Log.d("LIFECYCLE", "AllChatsListFragment onPause()");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == INTENT_REQUEST_NEW_GROUP_CHANNEL) {
            if (resultCode == RESULT_OK) {
                ...
                String newChannelUrl = data.getStringExtra(CreateChatActivity.EXTRA_NEW_CHANNEL_URL);
    ...
    private void setUpChannelListAdapter() {
        mChannelListAdapter.setOnItemClickListener(new AllChatsListAdapter.OnItemClickListener() {
            @Override
        ...
        mChannelListAdapter.setOnItemLongClickListener(new AllChatsListAdapter.OnItemLongClickListener() {
            @Override
